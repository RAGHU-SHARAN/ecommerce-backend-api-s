...
public class CartController {
	...
	/*
	 * @GetMapping("/{cartId}/my-cart") public ResponseEntity<ApiResponse>
	 * getCart( @PathVariable Long cartId) { try { Cart cart =
	 * cartService.getCart(cartId); CartDto cartDto =
	 * cartService.convertToDto(cart); return ResponseEntity.ok(new
	 * ApiResponse("Success", cartDto)); } catch (ResourceNotFoundException e) {
